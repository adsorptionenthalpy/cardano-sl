...
import           Pos.Core.Slotting (LocalSlotIndex (..), SlotCount, localSlotIndexMinBound,
                                    localSlotIndexSucc)
...
assignToSlots epochSlots = zip indices
  where
    indices = iterate (localSlotIndexSucc epochSlots) localSlotIndexMinBound
