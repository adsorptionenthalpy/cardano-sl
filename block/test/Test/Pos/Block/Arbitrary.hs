...
import           Pos.Core (GenesisHash (..), HasGenesisHash, HeaderHash, ProtocolConstants (..),
                           SlotCount, VssMaxTTL (..), VssMinTTL (..), genesisHash,
                           localSlotIndexMaxBound, localSlotIndexMinBound, pcEpochSlots)
...
dummyEpochSlots = pcEpochSlots dummyProtocolConstants
